...
# Настройки игры
TOWER_COST = 100
START_MONEY = 99999999999999999999999999999999999999999999999999
ENEMY_HEALTH = 100
ENEMY_SPEED = 1.0
BULLET_SPEED = 5
...
# tower_zones = [
#     pygame.Rect(55, 55, 50, 50),    # около (80, 80)
#     pygame.Rect(535, 55, 50, 50),   # около (560, 80)
#     pygame.Rect(175, 295, 50, 50),  # около (200, 320)
#     pygame.Rect(435, 295, 50, 50),  # около (460, 320)
#     pygame.Rect(295, 495, 50, 50)   # около (320, 520)
# ]
...
def main():
    ...
    while running:
        screen.blit(pygame.transform.scale(pygame.image.load('background.png'), (WIDTH, HEIGHT)), (0,0))
        clock.tick(FPS)
        # Обработка событий
